...
class Destination2Page extends StatefulWidget {
  const Destination2Page({Key? key}) : super(key: key);

  @override
  State<Destination2Page> createState() => _Destination2PageState();
}

class _Destination2PageState extends State<Destination2Page> {
